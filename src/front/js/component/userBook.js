...
export const UserBook = (book) => {
    ...
    return (
        <div className="d-flex flex-row p-2 border border-2 border-black rounded-5 mb-2" style={{background: "white"}}>
            <div className="d-flex flex-column w-50 align-items-center">
                <p className="fs-4">{book.name.substring(0, 14)}{book.name.length > 14 && '...'}</p>
